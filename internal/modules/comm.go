...
var AllCommands = BotCommands{
	...
	GroupUserCommands: []*telegram.BotCommand{
		...
		{Command: "help", Description: "Show help menu."},
		{Command: "info", Description: "Show user information."},
		{Command: "truth", Description: "Get a truth question."},
		{Command: "dare", Description: "Get a safe dare."},
		{Command: "dice", Description: "Roll a dice."},
		{Command: "dart", Description: "Throw a dart."},
		{Command: "basket", Description: "Play basketball."},
		{Command: "football", Description: "Play football."},
		{Command: "bowling", Description: "Play bowling."},
		{Command: "bored", Description: "Get an activity idea."},
	...
	GroupAdminCommands: []*telegram.BotCommand{
		...
		{Command: "zombies", Description: "Remove deleted accounts."},
		{Command: "tagall", Description: "Tag group members."},
		{Command: "admintag", Description: "Tag group admins."},
		{Command: "welcome", Description: "Toggle welcome messages."},
		{Command: "vclogger", Description: "Toggle VC join/leave logs."},
		{Command: "gali", Description: "Send a clean playful roast."},
		{Command: "tgm", Description: "Upload replied media."},
		{Command: "story", Description: "Create a harmless mini story."},
